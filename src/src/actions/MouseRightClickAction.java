 ...
 */
public class MouseRightClickAction implements MouseClickAction {
     ...
     * Constructor
     */
    public MouseRightClickAction(Position positionOnScreen) {
    ...
    public ActionEvent doAction() throws NoSuchMethodException {
        ...
        return new ActionEvent<ObjectHandler>(ObjectHandler.class, ObjectHandler.class.getMethod("doClick", Position.class), positionOnScreen);
    }
